...
def compute_scales(z_current):
	...
	z_10Myr = z_at_value(cosmo.age, cosmo.age(0.8) - (10.*u.Myr))
...
def main():
	ids = get_ids(9.5,10.5, 92)
	a_current, a_10Myr = compute_scales(0.8)
	get_masses_sfrs(ids, 92, a_current, a_10Myr, startid=575555)
